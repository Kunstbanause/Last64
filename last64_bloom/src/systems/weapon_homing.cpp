...
namespace Actor {
    ...
    void WeaponHoming::fire(const T3DVec3& position, const T3DVec3& direction) {
        ...
        Projectile::spawn(spawnPos, fireDirection, getFinalProjectileSpeed(projectileSpeed), projectileSlowdown, projectileLifetime, getFinalDamage(), projectileColor, projectileSize, getOwnerPlayerIndex(), weaponType);
    }
