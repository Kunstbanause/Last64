...
namespace Actor {
    ...
    public:
        ...
        float getRadius() const override { return 2.0f * size; } // Projectiles are 2x2 quads, scaled by size
        void getAABBSize(float& width, float& height) const override; // Projectiles are 4x4 quads
